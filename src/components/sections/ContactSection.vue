          ...
          <v-card :elevation="8" class="contact-info-card h-100" rounded="xl">
            <v-card-item class="pa-8">
              <div class="contact-section-title d-flex align-center">
                <v-icon color="primary" size="32" class="section-title-icon">mdi-information</v-icon>
              ...
              <div class="contact-item">
                <div class="contact-item-content">
                  <div class="contact-icon-wrapper primary">
                    <v-icon color="white" size="24" class="contact-item-icon">mdi-map-marker</v-icon>
                  </div>
              ...
              <div class="contact-item">
                <div class="contact-item-content">
                  ...
                  <div class="contact-item-text">
                    ...
                    <a href="tel:+33184603850" class="contact-item-value contact-link text-primary text-decoration-none">
                      +33 1 84 60 38 50
                    </a>
                  </div>
                </div>
              ...
              <div class="contact-item">
                <div class="contact-item-content">
                  ...
                  <div class="contact-item-text">
                    ...
                    <a href="mailto:contact@ebhi.fr" class="contact-item-value contact-link text-primary text-decoration-none">
                      contact@ebhi.fr
                    </a>
                  </div>
                </div>
            ...
            <v-card-item class="pa-8">
              ...
              <v-form ref="form" v-model="valid">
                ...
                >
                  ...
                  <span class="submit-btn-text">{{ loading ? 'Envoi en cours...' : 'Envoyer le message' }}</span>
                </v-btn>
              </v-form>
            </v-card-item>
          </v-card>
