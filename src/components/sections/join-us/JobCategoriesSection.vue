<template>
  <section id="job-categories" class="job-categories-section section-padding">
    <div class="job-categories-bg" aria-hidden="true">
      <div class="job-categories-shapes">
    ...
    <v-container class="job-categories-content">
...
.job-categories-bg::before {
  ...
  animation: jobCategoriesBgDrift 26s ease-in-out infinite alternate;
}
...
@keyframes jobCategoriesBgDrift {
  0% {
