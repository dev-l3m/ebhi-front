<template>
  <section class="locations-services-section section-padding">
    <div class="locations-services-bg" aria-hidden="true">
      <div class="locations-services-shapes">
    ...
    <v-container class="locations-services-content">
...
.locations-services-bg::before {
  ...
  animation: locationsServicesBgDrift 26s ease-in-out infinite alternate;
}

.locations-services-content {
  position: relative;
  z-index: 1;
}

.locations-services-shapes {
  position: absolute;
  inset: 0;
}
...
@keyframes locationsServicesBgDrift {
  0% {
