<template>
  <section class="services-cta-section section-padding">
    <div class="services-cta-background"></div>
    <v-container class="services-cta-content">
...
.services-cta-background::before {
  content: '';
  position: absolute;
  top: 0;
  left: 0;
