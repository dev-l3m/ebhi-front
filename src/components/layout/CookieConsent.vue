<template>
  <v-card v-if="showConsent" :elevation="24" class="cookie-consent" rounded="xl">
    <v-card-item class="cookie-consent-content">
      <div class="cookie-header">
        <div class="cookie-header-main">
          ...
          <div class="cookie-text-content">
            <v-card-title class="cookie-title mb-2 pa-0"> Gérer le consentement </v-card-title>
            <v-card-text class="cookie-description text-grey-darken-1 pa-0">
              ...
              cookies pour stocker et/ou accéder aux informations des appareils. Le fait de
              consentir à ces technologies nous permettra de traiter des données telles que le
              comportement de navigation ou les ID uniques sur ce site. Le fait de ne pas consentir
              ou de retirer son consentement peut avoir un effet négatif sur certaines
              caractéristiques et fonctions.
            </v-card-text>
          </div>
        </div>
        <v-btn icon variant="text" size="small" @click="showConsent = false" class="close-btn">
      ...
      <v-expand-transition>
        <div v-if="showDetails" class="cookie-details mt-4">
            ...
            >
              <div class="cookie-category-header">
                <div class="cookie-category-info">
                  <v-icon :color="category.color" size="24" class="category-icon">{{
                    category.icon
                  }}</v-icon>
          ...
          <div class="mt-4">
            <v-btn variant="text" size="small" class="text-primary" @click="showDetails = false">
